...
#define blendMode (BLEND_MODE)
#define blurLayer (BLUR_LAYER)

// 3D viewport uniforms
#define viewMode (VIEW_MODE)
...
void main() {
    ...
    // Match the normalized nm_fragment nm_kernel's minimum support. Keep the
    ...
    // Quad nm_vertex offsets (two triangles: 0-1-2, 2-1-3)
