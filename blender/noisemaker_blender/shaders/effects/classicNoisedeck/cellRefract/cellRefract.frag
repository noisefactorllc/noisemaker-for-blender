...
// definition.js `globals.{shape,nm_kernel}.define`). Same Knob 2 rationale as
// classicNoisedeck/effects: shape is dispatched 25 times per pixel inside
// the cells() inner loop, and nm_kernel is the same multi-way convolution
...
vec3 convolve(vec2 localUV, float nm_kernel[9], bool divide) {
