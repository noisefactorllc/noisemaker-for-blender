...
float nm_constant(vec2 st, float xFreq, float yFreq, float s) {
...
float value(vec2 st, float xFreq, float yFreq, float s) {
    float x1y1 = nm_constant(st, xFreq, yFreq, s);
    ...
    float x1y2 = nm_constant(vec2(st.x, st.y + ndY), xFreq, yFreq, s);
    float x2y1 = nm_constant(vec2(st.x + ndX, st.y), xFreq, yFreq, s);
    float x2y2 = nm_constant(vec2(st.x + ndX, st.y + ndY), xFreq, yFreq, s);
...
float maskValue(vec2 st, float xFreq, float yFreq, float s) {
    return nm_constant(st, xFreq, yFreq, s);
}
