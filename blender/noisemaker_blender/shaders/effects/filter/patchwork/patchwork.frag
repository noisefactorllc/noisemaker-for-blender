 ...
 * full nm_sample footprint stays inside the cell's own bounds, never
 ...
 * neighbor nm_sample (e.g. gc+-1px, S8's usual central-difference taps)
...
// nm_sample UV, clamped so the 3x3 mini-blur and neighbor-cell samples never
...
// precedent): spaced at squareSize*0.25 so the full nm_sample footprint
