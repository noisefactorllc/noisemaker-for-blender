 ...
 *
 * Border wobble: before the Voronoi search, the nm_sample position is
 ...
 * only displaces the nm_sample along the (1,1) diagonal, leaving
 ...
 * uses for its cheap-to-nm_sample blurred-luminance height field, would
