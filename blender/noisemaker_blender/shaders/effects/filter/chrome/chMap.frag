 ...
 * luminance height field h (S2 lum), self-distorts its OWN nm_sample point by
 ...
 *
 * h2 = lum(blur at uv2): the height field re-read at the distorted nm_sample
 ...
 *
 * Y-orientation: h/h2 nm_sample _chBlur (a same-effect prior-pass FBO) through
 ...
 * directional light, no rotation, nothing else nm_fragment-coordinate-derived
